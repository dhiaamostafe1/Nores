...
class BoxImport implements ToModel
{
    /**
    * @param array $row
    *
    ...
    */
    public function model(array $row)
    {
        ...
        $cat = Account_Tree::where('AccountSource', '=',$count->box)->count();
        $king = Account_Tree::where('id', '=',$count->box)->firstorfail();
