...
//Acepta los cambios de la edición
 ...
 var Entryitems =$('#IdCategoryInput').val();
  ...
  IterarCamposEdit($cols, function($td) {  //itera por la columnas
    ...
    if(countAr==5)
    {
      ...
      $.ajax({
        ...
        data:{  'id':$idEntry,'Ent':Entryitems,'flag':$flagAditeOrinsert ,'arr':Ardata ,'code':EntryitemsCode },
        cache:false,
        success: function (data) {
...
function butRowEdit(but) {  
  ...
  IterarCamposEdit($cols, function($td) {  //itera por la columnas
     ...
     // var input= '<input class="form-control input-sm"   onkeyup="butclickdd(this);" data-links="3" value="' + cont + '">  <div class="product_list" ></div>'; 
      // butclickdd(this);
      if(count==0)
         var input= '<input class="form-control  input-sm"  data-links="3" onkeyup="butUnite(this);"  value="' + cont + '">  <div class="product_list" ></div>';
      else if(count==6)
