  ...
  IterarCamposEdit($cols, function($td) {  //itera por la columnas
    ...
    if(countAr==7)
    {
      ...
      $.ajax({
        ...
        data:{  'id':$idEntry,'Ent':Entryitems,'flag':$flagAditeOrinsert,'COS_Cent_NAMe':Ardata[6],'End_NOT':Ardata[5],'Catch':Ardata[4]  ,'Dain':Ardata[3],'Madin':Ardata[2],'ACC_Name':Ardata[1],'ACC_NO': Ardata[0]},
        cache:false,
        success: function (data) {
