    ...
    <div class="card  mb-3">
        ...
        <div class="card-body">
            <form id="CategoryItems"  action="#">
                ...
                <input type="hidden" id="flagpage" value="1">
                @php
                    $code=$item->Item_cod;
                    $IdItems=$item->id;
                @endphp
                <input type="hidden" id="IdEntryInput" value="{{$item->id}}">
                    <div class="row ">
                        <div class="col-lg-4">
                            ...
                            <div class="row ">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">{{ __('Rest.ENT_NO')}}</label>
                                <div class="col-sm-9">
                                <input type="text" class="form-control" id="inputItemInt_NO" readonly value="{{$item->id }}">
                                </div>
                            </div>
                            <div class="row mb-1">
                        ...
                        <div class="col-lg-4">
                            <div class="row mb-1">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control inputsearchkind" list="datalistOptions" data-links="1"  data-store="{{$item->ENd_kind}}" id="inputItemENT_KIND" value="{{$type}}">
                                    <div class="product_list" >
                  ...
                  <div class="row ">
                      <div class="col-lg-4">
                          ...
                          <div class="row ">
                              <label for="inputEmail3" class="col-sm-3 col-form-label">{{ __('Rest.ENT_NO')}}</label>
                              <div class="col-sm-9">
                              <input type="text" class="form-control" id="inputItemInt_NOnew" readonly  >
                              </div>
                          </div>
                          <div class="row mb-1">
                              <label for="inputPassword3" class="col-sm-3 col-form-label">{{ __('Rest.BRNCH_NO')}}</label>
                      ...
                      <div class="col-lg-4">
                          <div class="row mb-1">
                              <label for="inputEmail3" class="col-sm-3 col-form-label">{{ __('Rest.ENT_KIND')}}</label>
                              <div class="col-sm-9">
                                  <input class="form-control inputsearchkind" list="datalistOptions" data-links="1"  data-store="0" id="inputItemENT_KINDnew" >
                                  <div class="product_list" >
...
<script src="{{asset('js/EntrySub.js')}}"></script>
<script>
