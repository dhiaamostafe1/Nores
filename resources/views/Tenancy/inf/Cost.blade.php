    ...
    <div class="card-header" style="padding: 8px 14px 0px 14px">
        <div class="row">
            <div class="col-lg-9 col-sm-6 col-xs-6 mb-2">
                <h4 class="d-flex flex-row">{{__('EntryType.Cost')}}</h4>
            </div>
                ...
                <tbody  id="CostItemtable">
                    ...
                    @foreach ($Cost as $item)
                        <tr id="CostTr{{$item->id }}">
                            ...
                            <td id="EntryTypename{{$item->id }}"> <span id="unitedeletitem{{$item->id }}">{{$item->TAK_NAME }}</span></td>
                            <td >
...
<div class="modal fade" id="StoreCostModel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <form id="StoreCostForm"  action="#">
            @csrf
            <div class="modal-body">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <div class="row mb-3">
                    <label for="exampleInputPassword1" class="col-sm-3 form-label">{{__('EntryType.Cost')}}</label>
                    <div class="col-sm-9">
