      ...
      <div class="card-body">
        <form id="CategoryItems"  action="#">
          ...
          @foreach ($data as $item)
            ...
            <input type="hidden" id="kindffatoorah" value="11">
            @php
                $code=$item->Item_cod;
                $IdItems=$item->id;
            @endphp
            ...
            {{-- <input type="hidden" id="Idtype" value="{{ $type }}"> --}}
                <div class="row ">
                    ...
                    <div class="col-lg-4">
                      <div class="row mb-1">
                        <label for="inputEmail3" class="col-sm-4 col-form-label">{{__('fatoorah.supplier')}}</label>
                        <div class="col-sm-8">
                          <input class="form-control inputsearch"  id="inputItemClient" data-store="{{$item->Cus_NO}}" data-links="{{$sys->supplier}}" value="{{$cleint}}">
            ...
            <div class="row ">
                ...
                <div class="col-lg-4">
                  <div class="row mb-1">
                    <label for="inputEmail3" class="col-sm-4 col-form-label">{{__('fatoorah.supplier')}}</label>
                    <div class="col-sm-8">
                      <input class="form-control inputsearch"  id="inputItemClient" ata-store="0"   data-links="{{$sys->supplier}}">
