...
@section('body')
<input type="hidden" class="form-control" id="flageaccount"  value="Store" required>
<div class="card">
    <div class="card-header" style="padding: 8px 14px 0px 14px">
        
        <div class="row">
            <div class="col-lg-9 col-sm-6 col-xs-6 mb-2">
                <h4 class="d-flex flex-row">{{__('AccoundGriude.Store')}}</h4>
            </div>
            <div class="col-lg-3 col-sm-6 col-xs-6 ">
                <div class="btn-group" role="group" aria-label="Basic example">
                    <a href="{{route('store.print')}}" class="d-flex fa fa-file-pdf-o  fa-2x flex-row-reverse p-1" ></a>
                    <a href="{{route('store.Excal')}}" class="d-flex fa fa-file-excel-o fa-2x flex-row-reverse p-1" ></a>
               
                    @if (getrull(session()->get('loginuser'), 27,'Inter'))
    ...
    <div class="modal-content">
        ...
        <form id="StoreBankForm"  action="#">
            ...
            <div class="modal-body">
                ...
                <div class="row mb-3">
                    <label for="exampleInputPassword1" class="col-sm-2 form-label">{{__('AccoundGriude.Store')}}</label>
                    <div class="col-sm-10">
...
<div class="modal fade" id="InportBankModel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <form  method="POST" action="{{route('Bank.import')}}" enctype="multipart/form-data">
            <input type="hidden" name="flage" value="store">
            @csrf
            <div class="modal-body">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <div class="row mb-3">
