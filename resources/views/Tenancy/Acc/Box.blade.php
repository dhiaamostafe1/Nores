...
@section('body')
<input type="hidden" class="form-control" id="flageaccount"  value="box" required>
    ...
    <div class="card-header" style="padding: 8px 14px 0px 14px">
        ...
        <div class="row">
            <div class="col-lg-9 col-sm-6 col-xs-6 mb-2">
                <h4 class="d-flex flex-row">{{__('AccoundGriude.Box')}}</h4>
            </div>
    ...
    <div class="modal-content">
        ...
        <form id="StoreBankForm"  action="#">
            ...
            <div class="modal-body">
                ...
                <div class="row mb-3">
                    <label for="exampleInputPassword1" class="col-sm-2 form-label">{{__('AccoundGriude.Box')}}</label>
                    <div class="col-sm-10">
